...
#define ILI9341_DELAY()  //ILI9341_Delay(10) 没使用延时 【编程技巧，积累】
...
void ILI9341_GPIO_Init(void)
{
  GPIO_InitTypeDef GPIO_InitStructure;
	...
	//把PB3 PB4引脚用作普通GPIO！！！！！！，在未设定之前PB3、PB4是用作JTAG下载接口！！！
	//不能使用JTAG功能  JTAG：烧录接口 烧录接口使用到 PB3 和 PB4！！！！！！！
	GPIO_PinRemapConfig(GPIO_Remap_SWJ_JTAGDisable,ENABLE);  //需要注意到的地方
...
void LCD_Init(void)
{
	...
	ILI9341_GramScan(4);//配置扫描模式为6，一般配置为5或6模式 【可以根据情况修改模式】！！
