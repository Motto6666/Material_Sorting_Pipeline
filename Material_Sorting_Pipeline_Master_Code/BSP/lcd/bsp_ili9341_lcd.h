...
#define      ILI9341_DATA_PIN                  GPIO_Pin_All//定义了PB端口的全部引脚（PB0~PB15）
...
#define  		LCD_DATA_OUT(data)     			ILI9341_DATA_PORT->ODR = data //GPIO_Write(ILI9341_DATA_PORT,data),直接操作寄存器，可以参考该编程!!
